...
def build_stage1_scenario_template(
    ...
    *,
    ...
    stage1_payload = {
        ...
        "completion_tolerance": float((stage1_config or {}).get("completion_tolerance", 1e-6)),
        "ga": {
    ...
    stage2_payload = {
        ...
        "completion_tolerance": float(
            (stage2_config or {}).get(
                "completion_tolerance",
                stage1_payload["completion_tolerance"],
            )
        ),
        "label_keep_limit": (stage2_config or {}).get("label_keep_limit"),
    }
