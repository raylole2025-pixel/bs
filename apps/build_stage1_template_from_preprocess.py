...
def main() -> None:
    ...
    parser.add_argument("--theta", type=float, default=0.90, help="Deprecated alias for --theta-sr")
    parser.add_argument("--theta-sr", type=float, default=None, help="Stage1 near-hard completion-rate threshold")
    ...
    parser.add_argument("--theta-c", type=float, default=0.95, help="Per-task near-completion threshold used by SR_theta_c")
