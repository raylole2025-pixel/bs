...
def _build_cases_from_args(args: argparse.Namespace) -> tuple[str, list[dict], list[dict]]:
    ...
    return suite_name, cases, rho_values
...
def main() -> None:
    ...
    parser.add_argument("--experiment-spec", default=None, help="Optional JSON spec that defines cases and rho variants")
    ...
    suite_name, cases, rho_values = _build_cases_from_args(args)
